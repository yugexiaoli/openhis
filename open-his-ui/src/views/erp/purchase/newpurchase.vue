    ...
    <el-card class="mycard">
      ...
      >
        <el-form-item label="单据号" prop="purchaseId">
          <el-input v-model="form.purchaseId" disabled size="small" />
        </el-form-item>
    ...
    <el-card class="mycard">
      ...
      >
        ...
        <el-table-column align="center" label="操作" width="auto">
          <template slot-scope="scope">
            <el-button type="danger" @click="handleDeleteItem(scope.$index)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
...
import { addPurchase, addPurchaseToAudit, generatePurchaseId } from '@/api/erp/purchase/purchase'
