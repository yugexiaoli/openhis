...
<script>
import { listForPage, addDictData, updateDictData, getOne, deleteDictDataByIds } from '@/api/system/dict/data'
import { typegetOne, selectAllDictType } from '@/api/system/dict/type'
export default {
  data() {
    return {
      // 遮罩层
