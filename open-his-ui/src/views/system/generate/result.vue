<template>
  <div class="app-container">
    ...
    <div v-else>
      <el-container style="width:100%;height:760px;">
        <el-aside>
          <el-button
        ...
        <el-main v-show="fileInfo.content.length > 0" class="el_main">
          <el-button
            type="text"
...
import { generatecode } from '@/api/system/generator/generator'
export default {
  ...
  methods: {
    onGenerate() {
      ...
      generatecode(this.clientParam).then(resp => {
        this.loading = false
...
.vue-codemirror .CodeMirror .cm-s-neat{
   height:800px;
}
</style>
