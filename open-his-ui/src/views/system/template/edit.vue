  ...
  <div class="app-container">
    ...
    <el-row :gutter="20">
      <el-col :span="16">
        ...
        <el-button @click="gotback">返 回</el-button>
      </el-col>
      <el-col :span="8">
        <h3>Velocity变量</h3>
...
import { templateupdate, templateadd, templateget } from '@/api/system/generator/template'
...
export default {
  ...
  methods: {
    gotback() {
      this.$router.push('/systemutil/List')
    },
    loadVelocityVar() {
      ...
      this.$refs.dialogForm.validate((valid) => {
        if (valid) {
          ...
          if (!this.formData.id) {
            ...
            templateupdate(this.formData).then(resp => {
              // this.formData.id = resp.data.id
              this.tip('修改成功')
            })
          }
