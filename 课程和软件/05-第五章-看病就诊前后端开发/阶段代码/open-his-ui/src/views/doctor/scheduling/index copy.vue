      ...
      <el-col :span="24">
        <el-card>
          <div style="text-align:center">
            <span>{{ schedulingData.startTimeThisWeek }}</span>-<span>{{ schedulingData.endTimeThisWeek }}</span>
          </div>
        </el-card>
      </el-col>
    </el-row>
...
export default {
  data() {
    return {
      ...
      schedulingData: {
        startTimeThisWeek: '2020-07-27(周一)',
        endTimeThisWeek: '2020-08-02(周日)'
      },
      // 排班表的数据   应该从后台查询
      tableData: [ // 医生和科室信息mock数据，该数据假设已经按着部门信息进行排序
        { userId: 2, deptId: 101, subsectionType: '1', schedulingType: ['', '1', '1', '1', '1', '1', '2'] },
        { userId: 2, deptId: 101, subsectionType: '2', schedulingType: ['1', '1', '', '1', '1', '1', ''] },
        { userId: 2, deptId: 101, subsectionType: '3', schedulingType: ['1', '1', '1', '1', '1', '1', '2'] },
        { userId: 3, deptId: 102, subsectionType: '1', schedulingType: ['1', '1', '1', '1', '1', '1', '1'] },
        ...
        { userId: 4, deptId: 103, subsectionType: '1', schedulingType: ['1', '1', '2', '1', '1', '1', '1'] },
        { userId: 4, deptId: 103, subsectionType: '2', schedulingType: ['1', '1', '1', '1', '2', '1', '1'] },
